...
async function loadModel() {
  ...
  try {
    ...
    model = await loadGraphModel('https://raw.githubusercontent.com/tobias-roy/DOK-H5/refs/heads/MachineLearning/tf2/models/research/object_detection/inference_graph/mobilenetV2_320/tfjsconvert/model.json', {onProgress: (number) => console.log(number)})
