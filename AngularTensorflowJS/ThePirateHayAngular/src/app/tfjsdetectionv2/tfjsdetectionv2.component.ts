  ...
  `,
      ...
      export class TfjsdetectionComponentV2 implements OnInit, AfterViewInit {
        ...
        async loadModel(): Promise<any> {
          try {
            const model = await loadGraphModel('https://raw.githubusercontent.com/tobias-roy/DOK-H5/refs/heads/MachineLearning/tf2/models/research/object_detection/inference_graph/mobilenet_v2_lite/tfjsconvert/model.json',
        ...
        renderPredictions = (predictions: any[]): void => {
          ...
          detections.forEach((item: any) => {
            ...
            // Ensure the bounding box is within the canvas dimensions
            x = Math.max(0, x);
            y = Math.max(0, y);
